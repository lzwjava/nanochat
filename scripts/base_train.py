...
from nanochat.flash_attention import USE_FA3, USE_FA2, HAS_FA2
using_fa3 = USE_FA3
using_fa2 = USE_FA2
if using_fa3:
    ...
    if args.window_pattern != "L":
        print0(f"  Note: FA2 supports sliding window (window_pattern='{args.window_pattern}').")
else:
    print0("!" * 80)
    print0("WARNING: No Flash Attention available, using PyTorch SDPA fallback")
