#!/bin/bash
# Fresh d12 training: 10,000 steps from scratch with MLflow tracking + Flash Attention 2
...
echo "=== Fresh d12 training: 10k steps with MLflow + Flash Attention 2 ==="
...
python -m scripts.base_train \
    ...
    --run=d12-fresh-10k-fa2 \
    --model-tag=d12-fresh-fa2 \
    "$@"

echo ""
echo "=== Training complete ==="
echo "MLflow UI:  cd /mnt/data/nanochat && mlflow ui --port 5000"
echo "Evaluate:   python -m scripts.base_eval --device-batch-size=8 --model-tag=d12-fresh-fa2"
